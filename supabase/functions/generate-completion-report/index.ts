  ...
  try {
    ...
    const prompt = `
      ...
      **Instructions:**
      ...
      3.  'finalRecommendation': Write a concluding statement, confirming the MSME's compliance. Crucially, you must also suggest a forward-looking plan for the MSME. This plan should recommend establishing a Key Performance Indicator (KPI) framework for continuous monitoring, conducting annual benchmarking studies, and performing a Return on Investment (ROI) analysis to track financial benefits.
